...
class MetaAdsMCPClient:
    ...
    def __init__(self, base_url: str = "http://localhost:8080",
        ...
        Args:
            ...
            bearer_token: Rule1 Bearer token (Clerk JWT or pgs_xxx)
        ...
        if bearer_token:
            ...
            print("Using direct Meta token authentication")
        else:
            print("WARNING: No authentication provided - tools will require auth")
...
def main():
    ...
    bearer_token = os.environ.get("RULE1_BEARER_TOKEN")
    meta_token = os.environ.get("META_ACCESS_TOKEN")

    if not bearer_token and not meta_token:
        print("WARNING: No authentication tokens found in environment")
        print("   Set RULE1_BEARER_TOKEN or META_ACCESS_TOKEN for full functionality")
        print("   Using test token for demonstration...")
        bearer_token = "demo_token_12345"
    ...
    try:
        ...
        if "error" in parsed_content and "Authentication Required" in parsed_content["error"]["message"]:
            print("Result: Authentication required (expected with demo token)")
            print("   This confirms the HTTP transport is working!")
            print("   Use a real Bearer token for actual data access.")
        else:
    ...
    print("\nNext steps:")
    print("   1. Set RULE1_BEARER_TOKEN or pass a Clerk JWT")
    print("   2. Call any of the available Meta Ads tools")
